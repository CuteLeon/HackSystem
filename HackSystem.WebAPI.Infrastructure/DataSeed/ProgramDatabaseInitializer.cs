...
public static class ProgramDatabaseInitializer
{
    public static ModelBuilder InitializeProgramData(this ModelBuilder builder)
    {
        builder.Entity<ProgramDetail>().HasData(new[]
        {
            ...
            new ProgramDetail() { Id = "program0-icon-0828-hack-system000008", Enabled = true, Name = "TaskServer", IconUri="/images/ProgramIcons/TaskServerProgram.png", EntryAssemblyName="HackSystem.Web.TaskSchedule", EntryTypeName="HackSystem.Web.TaskSchedule.TaskSchedulerComponent", SingleInstance=true, Mandatory = true, EntryParameter = "{ \"Developer\": \"Leon\" }" },
