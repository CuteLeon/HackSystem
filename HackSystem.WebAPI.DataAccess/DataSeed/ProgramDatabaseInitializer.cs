    ...
    public static class ProgramDatabaseInitializer
    {
        public static ModelBuilder InitializeBasicProgramData(this ModelBuilder builder)
        {
            builder.Entity<BasicProgram>().HasData(new[]
            {
                ...
                new BasicProgram() { Id = "program0-icon-0828-hack-system000008", Enabled = true, Name = "TaskServer", IconUri="/images/ProgramIcons/TaskServerProgram.png", AssemblyName="HackSystem.Web.SystemProgram", TypeName="HackSystem.Web.SystemProgram.TaskServer.TaskServerComponent", IsSingleton=true, Integral = true },
